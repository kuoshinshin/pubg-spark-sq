        ...
        if (!comment.user) {
          ...
          if (comment.username || comment.user_id) {
            comment.user = {
              ...
              avatar: comment.avatar || `https://picsum.photos/seed/${comment.user_id || comment.id}/200/200`
            }
          } else {
            // 如果没有用户信息，使用默认值
            comment.user = {
              id: comment.id,
              name: '用户',
              avatar: `https://picsum.photos/seed/${comment.id}/200/200`
            }
          }
        }
        // 确保评论有timestamp字段
  ...
  if (isLoggedIn && token) {
    try {
      ...
      if (userInfo) {
        ...
        currentUser.value.avatar = userInfo.avatar || currentUser.value.avatar
    ...
    <div class="search-sort-bar">
      <div class="container">
        <div class="sort-toggle">
            ...
            <div class="toggle-slider" :class="{ 'hottest': sortType === 'hottest' }"></div>
          </div>
        ...
        <div class="content-area">
          ...
          <div class="posts-list">
            ...
            <div v-else-if="errorMessage" class="error-state">
              ...
              <p>{{ errorMessage }}</p>
              <button @click="fetchPosts" class="retry-button">重试</button>
            </div>
            ...
            <div v-else-if="filteredPosts.length > 0">
              ...
              >
                ...
                <div class="post-header">
                  <div class="post-user">
                    <img 
                      :src="post.avatar || post.user?.avatar || 'https://picsum.photos/seed/default/200/200'" 
                      :alt="post.username || post.user?.name || '未知用户'" 
                      class="user-avatar" 
                ...
                <div class="post-content">
                  ...
                  <div v-if="post.media" class="post-media-container">
                    <img v-if="post.mediaType === 'image'" :src="post.media" :alt="post.content" class="post-media image" />
                ...
                <div class="comments-section">
                  ...
                  <div class="comments-list">
                      ...
                      <div class="comment-content-wrapper">
                        ...
                        <template v-if="comment.user?.id == currentUser.id || comment.user?.name === currentUser.name">
                          <div class="comment-avatar-container">
                            <img :src="comment.user?.avatar || 'https://picsum.photos/seed/default/200/200'" :alt="comment.user?.name || '未知用户'" class="comment-avatar" />
                    ...
                    <div v-if="post.comments && post.comments.length > 2" class="comments-toggle">
                      <button class="comments-toggle-button" @click="toggleComments(post.id)">
                  ...
                  <div class="comment-input">
                    <img :src="currentUser.avatar" :alt="currentUser.name" class="comment-input-avatar" />
                    <input 
                      type="text"
            ...
            <div v-else class="empty-state">
              ...
              <button v-if="!searchKeyword.trim()" class="post-button" @click="openPostModal">
                发布动态
              </button>
            </div>
          </div>
...
.reply-input .comment-input-avatar {
  width: 28px;
  height: 28px;
}
